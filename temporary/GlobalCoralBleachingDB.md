...
permalink: /data/GlobalCoralBleachingDB/
layout: page
...
sourceURL: https://springernature.figshare.com/collections/A_Global_Coral-Bleaching_Database_GCBD_1998_2020/5314466
sourceShort: 
logo: 
defaultSeries: rdb
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/GlobalCoralBleachingDB/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/GlobalCoralBleachingDB/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
