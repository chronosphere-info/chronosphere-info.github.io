---
title: "Natural Earth"
permalink: /data/NaturalEarth/
layout: page
src: NaturalEarth
series: 
- code: land
  name: Land polygons including major islands
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/NaturalEarth/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/NaturalEarth/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
