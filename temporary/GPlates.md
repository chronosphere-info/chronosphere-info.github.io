...
sourceURL: https://www.gplates.org/
sourceShort: 
logo: 
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/GPlates/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/GPlates/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
