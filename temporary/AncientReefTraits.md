...
permalink: /data/AncientReefTraits/
layout: page
src: AncientReefTraits
series: 
- code: traits
  name: Denormalized Trait Data
- code: refs
  name: Reference list

description: 
sourceURL: https://art.nat.fau.de/
sourceShort: ART Database
logo: art_logo.png
defaultSeries: traits
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/AncientReefTraits/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/AncientReefTraits/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
