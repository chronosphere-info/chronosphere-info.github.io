...
- code: data
  name: Trait data
- code: resources
  name: Utilized resources

description: null
sourceURL: https://coraltraits.org/
sourceShort: 
logo: 
defaultSeries: data
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/CoralTraitDB/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/CoralTraitDB/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
