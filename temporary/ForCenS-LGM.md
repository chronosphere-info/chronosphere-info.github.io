---
title: "A compilation of planktonic foraminifera assemblage composition for the Last Glacial Maximum"
permalink: /data/ForCenS-LGM/
layout: page
src: ForCenS-LGM
series: 
- code: main
...
sourceURL: https://doi.pangaea.de/10.1594/PANGAEA.962852
sourceShort: 
logo: ForCensLGM.png
defaultSeries: main
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/ForCenS-LGM/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/ForCenS-LGM/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
