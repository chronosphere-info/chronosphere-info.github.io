---
title: "List of scleractinian genera in the Paleobiology Database and their inferred symbiotic mode"
permalink: /data/SOM-kiessling-coralgenera/
layout: page
src: SOM-kiessling-coralgenera
series: 
- code: list
  name: The list of coral genera

description: placeholder_ne_descr.file
sourceURL: https://zenodo.org/record/8054526
sourceShort: 
logo: 
defaultSeries: list
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/SOM-kiessling-coralgenera/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/SOM-kiessling-coralgenera/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
