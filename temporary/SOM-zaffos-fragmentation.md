...
permalink: /data/SOM-zaffos-fragmentation/
layout: page
src: SOM-zaffos-fragmentation
series: 
- code: fragment
  name: Continent fragmentation index

description: null
sourceURL: 
sourceShort: 
logo: 
defaultSeries: fragment
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/SOM-zaffos-fragmentation/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/SOM-zaffos-fragmentation/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
