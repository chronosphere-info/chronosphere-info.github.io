...
series: 
- code: vector
  name: A Bioregionalization of Coastal and Shelf Areas

description: null
sourceURL: https://www.worldwildlife.org/publications/marine-ecoregions-of-the-world-a-bioregionalization-of-coastal-and-shelf-areas
sourceShort: 
logo: 
defaultSeries: vector
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/MEOW/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/MEOW/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
