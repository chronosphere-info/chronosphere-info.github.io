...
permalink: /data/REF-veizer2015temperatures/
layout: page
src: REF-veizer2015temperatures
series: 
- code: deep
  name: Appendix A - Deep Sea Data
- code: surface
  name: Appendix B - Surface Data

description: placeholder_paleomap_descr.file
sourceURL: https://www.sciencedirect.com/science/article/pii/S0012825215000604#ec0005
sourceShort: 
logo: 
defaultSeries: surface
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/REF-veizer2015temperatures/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/REF-veizer2015temperatures/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
