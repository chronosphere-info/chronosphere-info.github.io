---
title: "EarthByte: Building a Virtual Earth"
permalink: /data/EarthByte/
layout: page
src: EarthByte
series: 
- code: MERDITH2021
  name: 'Plate model for ''Extending Full-Plate Tectonic Models into Deep Time: Linking
    the Neoproterozoic and the Phanerozoic'''

description: placeholder_paleomap_descr.file
sourceURL: https://www.earthbyte.org/
sourceShort: 
logo: 
defaultSeries: MERDITH2021
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/EarthByte/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/EarthByte/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
