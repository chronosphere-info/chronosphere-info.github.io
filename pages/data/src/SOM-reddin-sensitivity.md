---
title: "Repository for: Reddin et al. 2020. Marine clade sensitivities to climate change conform across time scales"
permalink: /data/SOM-reddin-sensitivity/
layout: page
src: SOM-reddin-sensitivity
series: 
- code: modern
  name: Modern metaanalysis support data

description: 
sourceURL: https://zenodo.org/record/3465281
sourceShort: 
logo: 
defaultSeries: modern
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/SOM-reddin-sensitivity/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/SOM-reddin-sensitivity/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
