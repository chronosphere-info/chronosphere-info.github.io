---
title: "PhanSST - A global database of Phanerozoic sea surface temperature proxy data"
permalink: /data/PhanSST/
layout: page
src: PhanSST
series: 
- code: db
...
sourceURL: https://www.paleo-temperature.org
sourceShort: 
logo: phansst.png
defaultSeries: db
---
...
<td>
{% if i.code == page.defaultSeries %}
<strong><a href="{{site.url}}{{site.basurl}}/data/PhanSST/{{i.code}}/">{{i.name }}</a></strong> <i>(default)</i>
{% else %}
<a href="{{site.url}}{{site.basurl}}/data/PhanSST/{{i.code}}/">{{i.name }}</a>
{% endif %}
</td>
